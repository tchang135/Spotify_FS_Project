...
song4 = Song.create!(album_id: 2, artist_id: 1, title: "In My Feelings", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Drake+%E2%80%93+In+My+Feelings+.mp3')
song5 = Song.create!(album_id: 2, artist_id: 1, title: "Nonstop", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Drake+-+Nonstop+.mp3')
song6 = Song.create!(album_id: 2, artist_id: 1, title: "God's Plan", url:"https://symphonifyphotos.s3.amazonaws.com/songs/Drake+-+God's+Plan+.mp3")
song7 = Song.create!(album_id: 3, artist_id: 1, title: "Hype", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Drake+-+Hype+.mp3')
song8 = Song.create!(album_id: 3, artist_id: 1, title: "Pop Style", url:'https://symphonifyphotos.s3.amazonaws.com/songs/DRAKE+-+POP+STYLE+.mp3')
song9 = Song.create!(album_id: 3, artist_id: 1, title: "Hotline Bling", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Drake+-+Hotline+Bling+.mp3')
song10 = Song.create!(album_id: 4, artist_id: 2, title: "Finesse", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+Finesse+.mp3')
song11 = Song.create!(album_id: 4, artist_id: 2, title: "That's What I Like", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+That%E2%80%99s+What+I+Like+.mp3')
song12 = Song.create!(album_id: 4, artist_id: 2, title: "Versace on the Floor", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+Versace+On+The+Floor+.mp3')
...
song16 = Song.create!(album_id: 6, artist_id: 2, title: "Talking to the Moon", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+Talking+To+The+Moon+.mp3')
song17 = Song.create!(album_id: 6, artist_id: 2, title: "Just the Way You Are", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+Just+the+Way+You+Are+.mp3')
song18 = Song.create!(album_id: 6, artist_id: 2, title: "Count on Me", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Bruno+Mars+-+Count+on+Me+.mp3')
song19 = Song.create!(album_id: 7, artist_id: 3, title: "LOYALTY", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Kendrick+Lamar+-+Loyalty+ft.+Rihanna.mp3')
song20 = Song.create!(album_id: 7, artist_id: 3, title: "DNA", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Kendrick+Lamar+-+DNA+.mp3')
song21 = Song.create!(album_id: 7, artist_id: 3, title: "HUMBLE", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Kendrick+Lamar+-+HUMBLE+.mp3')
...
song26 = Song.create!(album_id: 9, artist_id: 3, title: "Alright", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Kendrick+Lamar+%E2%80%93+Alright.mp3')
song27 = Song.create!(album_id: 9, artist_id: 3, title: "These Walls", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Kendrick+Lamar+-These+walls+.mp3')
song28 = Song.create!(album_id: 12, artist_id: 4, title: "THE SHADE", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+THE+SHADE+.mp3')
song29 = Song.create!(album_id: 12, artist_id: 4, title: "OPEN A WINDOWS", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+OPEN+A+WINDOW+.mp3')
song30 = Song.create!(album_id: 12, artist_id: 4, title: "AMAZING", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+AMAZING.mp3')
song31 = Song.create!(album_id: 10, artist_id: 4, title: "Untitled", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Untitled+-+Rex+Orange+County+.mp3')
song32 = Song.create!(album_id: 10, artist_id: 4, title: "Television / So Far So Good" , url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+What+About+Me+(Television+-+So+Far+So+Good)+.mp3')
song33 = Song.create!(album_id: 10, artist_id: 4, title: "Happiness", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+Happiness+.mp3')
song34 = Song.create!(album_id: 11, artist_id: 4, title: "Always", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+Always+.mp3')
song35 = Song.create!(album_id: 11, artist_id: 4, title: "Pluto Projector", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+Pluto+Projector+.mp3')
song36 = Song.create!(album_id: 11, artist_id: 4, title: "Face to Face", url:'https://symphonifyphotos.s3.amazonaws.com/songs/Rex+Orange+County+-+Face+To+Face+.mp3')
